                    ...
                    @while($query->have_posts())
                        ...
                        <div class="col-lg-8 col-sm-6 col-12 py-3 d-flex flex-column">
                            <article class="grid bg-white py-3 mx-lg-3 mx-0">
                                <h1 class="h5 pt-3 px-lg-5 px-3 pb-0"><strong class="bg-danger text-white">{{__('Article') }}</strong></h1>
                                <h2 class="h3 text-primary py-3 px-lg-5 px-3"><strong class="pl-0">@php the_title() @endphp</strong></h2>
                            ...
                            <div class="row">
                                <div class="col-12 py-3">
                                    <article class="grid bg-white py-3 mx-sm-3">
                                        <h2 class="h5 pt-3 px-lg-4 px-3 pb-0"><strong class="bg-danger text-white">{{__('Video') }}</strong></h2>
                        ...
                        <div class="col-lg-12 col-11 mx-auto heading">
                            <div class="row">
                                <div class="col-lg-9 col-12 mb-lg-0 mb-3 pl-lg-0">
                                    <h2><strong class="bg-danger text-white">Articles</strong></h2>
                                </div>
                ...
                <div class="col-lg-10 col-12 mx-auto py-lg-5 py-3">
                    <div class="row">
                        <div class="col-lg-12 col-11 mx-auto heading">
                            <div class="row">
                                <div class="col-lg-9 col-12 mb-lg-0 mb-3 pl-lg-0">
                                    <h2><strong class="bg-white text-danger">Videos</strong></h2>
                                </div>
                                <div class="col-lg-3 col-12">
                ...
                <div class="col-lg-10 col-12 mx-auto py-lg-5 py-3">
                    <div class="row">
                        <div class="col-lg-12 col-11 mx-auto heading">
                            <div class="row">
                                <div class="col-lg-9 col-12 mb-lg-0 mb-3 pl-lg-0">
                                    <h2><strong class="bg-danger text-white">Quizzes</strong></h2>
                                </div>
                                <div class="col-lg-3 col-12">
        ...
        <div class="col-lg-10 col-12 mx-auto">
            <div class="row">
                <div class="col-lg-10 col-12 mx-auto heading pb-2 mb-5">
                    <div class="row">
                        <div class="col-lg-9 col-12 mb-lg-0 mb-3 pl-lg-0">
                            <h1 class="h2"><strong class="bg-danger text-white">@php the_title() @endphp</strong></h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-10 col-12 mx-auto mb-5 pl-lg-0 text-primary">
