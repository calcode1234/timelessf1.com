<article class="page quiz bg-light">
    ...
    <div class="col-lg-10 col-12 mx-auto">
            ...
            <div class="col-lg-10 col-11 mx-auto heading pb-2 mb-5">
                <div class="row">
                    <div class="col-lg-9 col-12 mb-lg-0 mb-3 pl-lg-0">
                        <h1 class="h2"><strong class="bg-danger text-white">Quiz</strong></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-10 mx-auto pl-0 mb-5">
                <h2 class="text-primary"><strong>@php the_title() @endphp</strong></h2>
            </div>
        </div>

        <div class="row">
            <div class="col-lg-10 col-11 mx-auto mb-5 pl-lg-0 text-primary">
                ...
                <div class="col-lg-10 col-11 mx-auto heading pb-2">
                    <div class="row">
                        <div class="col-lg-9 col-11 mb-lg-0 mb-3 pl-lg-0">
                            <h2 class="h3"><strong class="bg-danger text-white">Related quizzes</strong></h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            @if( $quiz )
                                ...
                                <div class="col-lg-4 col-sm-6 col-12 d-sm-flex flex-sm-column">
                                    <article class="grid bg-light my-lg-5 my-3 py-3 flex-sm-grow-1">
                                        ...
                                        <h2 class="h4 text-primary py-3 px-lg-4 px-3"><strong class="pl-0">@php echo esc_html( $quiz->post_title ) @endphp</strong></h2>
