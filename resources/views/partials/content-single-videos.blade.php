<section class="page video bg-danger">
    ...
    <div class="col-lg-10 col-12 mx-auto">
            ...
            <div class="col-lg-10 col-11 mx-auto heading pb-2 mb-5">
                <div class="row">
                    <div class="col-lg-9 col-12 mb-lg-0 mb-3 pl-lg-0">
                        <h1 class="h2"><strong class="bg-white text-danger">Video</strong></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        @if(have_rows('content_video_single')) 
            @while(have_rows('content_video_single'))
                ...
                <div class="row">
                    <div class="col-10 mx-auto pl-0 mb-5 text-white">
                ...
                @if(have_rows('related_videos'))
                    <div class="row">
                        <div class="col-lg-10 col-11 mx-auto heading pb-2">
                            <div class="row">
                                <div class="col-lg-9 col-12 mb-lg-0 mb-3 pl-lg-0">
                                    <h2 class="h3"><strong class="bg-white text-danger">Related videos</strong></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @if( $video )
                                        ...
                                        <div class="col-lg-4 col-sm-6 col-12 d-sm-flex flex-sm-column">
                                            <article class="grid bg-white my-lg-5 my-3 py-3 flex-sm-grow-1">
                                                ...
                                                <h2 class="h4 text-primary py-3 px-lg-4 px-3"><strong class="pl-0">@php echo esc_html( $video->post_title ) @endphp</strong></h2>
